...
\correction{ An alternative approach is to consider the set of neural
  nodes as an undirected planar graphs in order to take advantage of a
  ...
  topology to map differents clusters. However, this approach cannot
  be easily generalized because the topology is tailored to the data. }
%
